...
<div class="conteudo">
        ...
        <h1 class="titulo">QUAL É O OBJETIVO DE LIBRAS?</h1>
       
        <br><p class="paragrafo">A Libras, Língua Brasileira de Sinais, é uma língua espaço-visual, com uma estrutura linguística e gramatical própria, diferente do português. Ela é uma das principais formas de comunicação das pessoas surdas no Brasil. Seu objetivo é promover a comunicação e o acesso à informação das pessoas surdas, para que possam estar integradas à sociedade.    
        ...
        <h3 class="titulo">QUAL A IMPORTANÂNCIA DO ENSINO DE LIBRAS NO FUNDAMENTAL?</h3>

       <p class="paragrafo"> Ensinar Libras desde cedo para as crianças é super positivo para o desenvolvimento de suas potencialidades, sejam elas surdas ou ouvintes. Como você deve saber, aprender novas línguas é algo muito mais fácil de se fazer na infância, então é uma época que deve ser aproveitada para desenvolver nos alunos uma aprendizagem mais significativa.
            <br>
            <br>
        ...
        Já quando a Libras é ensinada para pessoas ouvintes, é chamada de L2. Com esse método o educador pode fazer uso tanto da visão para ensinar a maneira certa de se sinalizar, quanto a oralização para explicar o significado dos sinais. </p>           
            ...
            <div class="links">
                <div class="imagem">
                    ...
                    <a href="https://www.ead.senac.br/cursos-livres/libras-basico/" target="_blank"><img src="imagens/senac-libras.png" alt="" srcset=""></a>
                </div>              
            </div>                 
